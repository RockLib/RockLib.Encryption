...
public static class Crypto
{
    ...
    public static string Encrypt(string plainText, string? credentialName = null) => Current.Encrypt(plainText, credentialName);
    ...
    public static string Decrypt(string cipherText, string? credentialName = null) => Current.Decrypt(cipherText, credentialName);
    ...
    public static byte[] Encrypt(byte[] plainText, string? credentialName = null) => Current.Encrypt(plainText, credentialName);
    ...
    public static byte[] Decrypt(byte[] cipherText, string? credentialName = null) => Current.Decrypt(cipherText, credentialName);
    ...
    public static IEncryptor GetEncryptor(string? credentialName = null) => Current.GetEncryptor(credentialName);
    ...
    public static IDecryptor GetDecryptor(string? credentialName = null) => Current.GetDecryptor(credentialName);
