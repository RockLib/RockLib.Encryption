...
### RockLib.Encryption [![Build status](https://ci.appveyor.com/api/projects/status/lgnokx2h198x19i8?svg=true)](https://ci.appveyor.com/project/bfriesen/rocklib-encryption)
